        ...
        const carouselData = {
            carousel1: [
                ...
                { src: '../img/templos/7.png', alt: 'Foto 7', caption: '"A Modernização da Crença" - Rafael Lopes, 10/06/2025' },
                { src: '../img/templos/8.png', alt: 'Foto 8', caption: '"Paraíso" - Jhonata Alves, 26/05/2025' },
                { src: '../img/templos/9.png', alt: 'Foto 9', caption: '"Exército de São Jorge" - Jhonata Alves, 26/05/2025' },
                { src: '../img/templos/10.png', alt: 'Foto 10', caption: '"Deus e a Criação" - Hernandes Arthur, 03/06/2025' },
            ]
        };
